    ...
    return (
        <div className="flex flex-col items-center gap-7">
            <input
                ...
                className="mt-1 block border pl-5 pr-16 py-3 rounded-md w-full max-w-lg focus:outline-none text-lg text-leftm h-12 bg-black text-gray-100"
            />
            <div className="flex gap-3">
                <button
                    onClick={onSearch}
                    className="px-7 py-3 bg-yellow-400 text-black hover:text-white rounded-md hover:bg-yellow-500"
                >
                    <FaSearch />
                </button>
                <button
